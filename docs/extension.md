...
The browser extension is a React Chrome Manifest V3 side panel for capturing Applications from job posting webpages. It is a focused capture surface, not a general Notion editor, not an Application Analysis interface, and not a Resume Creation interface.
